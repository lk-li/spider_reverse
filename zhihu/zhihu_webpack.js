            ...
            l.prototype.O = function(A, C, s) {
                for (var t, S, h, i, B, Q, G, D, w, g, a, e, E, T, r, V, U, M, O, c, I; this.T < this.w; )
                    try {
                        switch (this.T) {
                        case 27:
                            console.log('case:', this.T, 'this.C[this.I] >> this.C[this.F]-->', this.C[this.I], '>>', this.C[this.F], '=', this.C[this.I] >> this.C[this.F]),
                        ...
                        case 94:
                            ...
                            break;
                        case 101:
                            console.log('case:', this.T, 'this.C[this.I] in this.C[this.F]-->', this.C[this.I], 'in', this.C[this.F], '=', this.C[this.I]in this.C[this.F]),
                        ...
                        case 168:
                            ...
                            break;
                        case 254:
                            console.log('case:', this.T, 'eval----》', eval(i)),
                        ...
                        case 278:
                            ...
                            break;
                        case 283:
                            console.log('case:', this.T, 'evals----》', eval(String.fromCharCode(this.C[this.I]))),
                        ...
                        case 368:
                            //判断运行时间的地方
                            //console.log('this.t-11111>>>',this.T);
                            //this.T -= 500 < S - this.a ? 24 : 8;
                            //console.log('this.t-22222>>>',this.T);
                            //修改成如下
                            this.T = 360;
                            break;
                        case 380:
                        ...
                        case 465:
                            ...
                            console.log('case:', 465, 'this.C[this.W][Q]:', this.C[this.W][Q], 'this.C[' + this.W + '][' + Q + '][' + G[+[]] + ']', 'this.C[3] ', this.C[3])
                            break;
                        case 466:
                        ...
                        case 486:
                            ...
                            break;
                        case 491:
                            console.log('case:', this.T, new this.C[this.W].apply(null,G)),
                        ...
                        //console.log("case:", this.T, ",运算结果:", this.C[3])
                    } catch (A) {
...
// md5_str = "8c84d845d00b1eb935f05adc10fba2ce"
md5_str = "dde77ad1bfeafca7fa2d50122621f579"
signature = _encrype(md5_str)
