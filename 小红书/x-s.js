...
function des(_str) {
    ...
    var keys = [170135592, 943396125, 188091652, 940642585, 203819052, 960042515, 791809289, 940319282, 154347313, 723321368, 890975264, 956902948, 1024459794, 185540652, 622531092, 120009992, 873535509, 53420041, 924662276, 119936026, 839450637, 118951446, 875374343, 372376066, 437003809, 908466438, 170860555, 70920229, 321267986, 1009791244, 187570186, 339223301];//des_createKeys (key);
